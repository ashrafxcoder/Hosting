...
namespace Microsoft.AspNetCore.Hosting.Internal
{
    public class StartupLoader
    {
        ...
        /// </remarks>
        /// <param name="hostingServiceProvider">The <see cref="IServiceProvider"/> with the hosting services.</param>
        /// <param name="startupType">The startup type.</param>
        /// <param name="environmentName">The environment name.</param>
        /// <returns>
        /// The <see cref="StartupMethods"/> with the code to run for configuring the application services and the request pipeline.
        /// </returns>
